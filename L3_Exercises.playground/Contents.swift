...
var someArray = [Bool]()
someArray = [true, false, false, true, false]
...
var Daniel = waitingList.remove(at: 1)
...
var mydictionary = Dictionary<String, Bool>()
...
mydictionary = ["Anchovies": true, "Coconut": true, "Cilantro":true, "Liver":true]
...
if let mystring = presidentialDogs["Barack Obama"]{
    print("Michele Obama walks \(mystring) every morning.")
}
